...
<div class="min-h-screen bg-stone-50">
                ...
                <div>
                    <nav class="flex" aria-label="Breadcrumb">
                        <ol class="flex items-center space-x-4">
                            <li>
                                <a href="{{ route('admin.shipping-methods.index') }}" class="text-stone-400 hover:text-stone-500">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="{{ route('admin.shipping-methods.index') }}" class="ml-4 text-sm font-medium text-stone-500 hover:text-stone-700">Shipping Methods</a>
                                </div>
                            </li>
                            <li>
                                <div class="flex items-center">
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form method="POST" action="{{ route('admin.shipping-methods.store') }}" class="space-y-8">
            @csrf
