      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="space-y-3">
          ...
          <div class="relative flex items-center" id="thumbnail-container">
            <button class="absolute left-0 z-10 w-6 h-6 bg-white border border-gray-200 rounded-full flex items-center justify-center shadow-md hover:bg-gray-50 transition-all hidden" id="quickViewThumbnailPrevBtn" onclick="scrollQuickViewThumbnails(-1)" style="top: 50%; transform: translate(-50%, -50%);">
